# LoC subject normalization backlog

Generated list of subject slugs returned by Library of Congress lookups that are not yet mapped into the Bookshelves taxonomy.

| Subject slug | Occurrences | Example enrichment file | Notes |
| --- | --- | --- | --- |
| `1900-1999` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Mapped to new `era-1900s` setting tag |
| `adventure-fiction` | 1 | `enrichment_data/033508ff-bb34-41d9-aef2-141f4ed8dc84.json` | Map to existing `adventure-action` tag |
| `authors-american` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Skip – bibliographic/author-nationality heading |
| `authors-american-20th-century-correspondence` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Skip – archival correspondence |
| `bravard-robert-s-correspondence` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Skip – archival correspondence |
| `childrens-literature-polish` | 1 | `enrichment_data/03082e3d-3058-471b-a901-2956c1856f1e.json` | Skip for now – language-specific scholarship |
| `childrens-literature-polish-history-and-criticism` | 1 | `enrichment_data/03082e3d-3058-471b-a901-2956c1856f1e.json` | Skip – language-specific scholarship |
| `copyright-titles-united-states` | 1 | `enrichment_data/033508ff-bb34-41d9-aef2-141f4ed8dc84.json` | Skip – cataloging/admin topic |
...
| `ecofiction-20th-century-history-and-criticism` | 1 | `enrichment_data/00df7f2a-9ba5-4835-a09a-2b87c50c81ec.json` | Alias to `climate-change` (mapping added) |
| `ecofiction-21st-century-history-and-criticism` | 1 | `enrichment_data/00df7f2a-9ba5-4835-a09a-2b87c50c81ec.json` | Alias to `climate-change` (mapping added) |
| `encyclopedias-and-dictionaries` | 1 | `enrichment_data/033508ff-bb34-41d9-aef2-141f4ed8dc84.json` | Mapped to `reference` |
| `english-language-grammar` | 1 | `enrichment_data/033508ff-bb34-41d9-aef2-141f4ed8dc84.json` | Alias to `linguistics` |
| `essays-criticism` | 1 | `enrichment_data/00df7f2a-9ba5-4835-a09a-2b87c50c81ec.json` | Already in taxonomy – verify ingestion wiring |
| `fantasy-fiction-history-and-criticism` | 1 | `enrichment_data/03082e3d-3058-471b-a901-2956c1856f1e.json` | Maps to `fantasy` |
| `fiction` | 1 | `enrichment_data/04537132-0262-4928-90cc-3b1abdbf04c4.json` | Redundant with domain – ignore |
| `forecasting` | 1 | `enrichment_data/068a9286-750d-489b-8d68-b56825151747.json` | Alias to `future-tense` |
| `france-paris` | 1 | `enrichment_data/04537132-0262-4928-90cc-3b1abdbf04c4.json` | Mapped to `paris` tag |
| `german-literature-translations-into-english` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Skip – translation catalog heading |
| `german-prose-literature-history-and-criticism` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Skip – regional scholarship |
| `great-britain-bibliography-catalogs` | 1 | `enrichment_data/033508ff-bb34-41d9-aef2-141f4ed8dc84.json` | Skip – archival bibliography |
| `holocaust-jewish-1939-1945-in-literature` | 1 | `enrichment_data/03082e3d-3058-471b-a901-2956c1856f1e.json` | Mapped to `holocaust` |
| `housekeepers-fiction` | 1 | `enrichment_data/04b43824-68d4-4ccb-bc3e-48570d9de19a.json` | Mapped to `domestic-fiction` |
| `incunabula-england-bibliography-catalogs` | 1 | `enrichment_data/033508ff-bb34-41d9-aef2-141f4ed8dc84.json` | Skip – archival bibliography |
| `love-stories` | 1 | `enrichment_data/04b43824-68d4-4ccb-bc3e-48570d9de19a.json` | Maps to `romance` |
| `mcgraw-erin-1957-correspondence` | 1 | `enrichment_data/05eaef7d-9e38-4e02-8fec-358dd2b16ed8.json` | Skip – author-specific correspondence |
| `memory-in-literature` | 1 | `enrichment_data/03082e3d-3058-471b-a901-2956c1856f1e.json` | Mapped to `memory-narrative` |
