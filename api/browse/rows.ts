...
function mapEntry(e: any): BookSearchResult {
  ...
  return { id: e.key, title: e.title ?? null, author, cover, year: null };
}

async function fetchSubject(subject: string, limit = 20): Promise<BookSearchResult[]> {
